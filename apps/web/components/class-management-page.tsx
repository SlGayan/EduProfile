  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(o) => { if (!o) onClose() }}>
        <DialogContent className="flex max-h-[85vh] w-full max-w-full flex-col gap-0 overflow-hidden p-0 sm:max-w-2xl">
          <DialogHeader className="sticky top-0 z-10 shrink-0 gap-1 border-b bg-background px-4 py-4 sm:px-6">
          ...
          <div className="max-h-[60vh] flex-1 space-y-6 overflow-y-auto px-4 py-4 sm:px-6">
            {/* Enrolled students */}
                        ...
                        <TableRow key={s.id}>
                          ...
                          <TableCell>
                            ...
                            >
                              ...
                              <span className="sr-only">Remove {s.fullName}</span>
                            </Button>
                          </TableCell>
                        </TableRow>
                      ))}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Remove <strong>{removeTarget?.fullName}</strong> from{" "}
...
function ClassManagementPageInner() {
  ...
  // Deep-link support for `?create=1` — a Principal or Admin Dashboard
  // "Create Class" quick action lands here and should open the dialog
